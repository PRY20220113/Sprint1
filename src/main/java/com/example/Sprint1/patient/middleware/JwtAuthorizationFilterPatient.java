...
import com.example.Sprint1.patient.service.PatientServiceImpl;

public class JwtAuthorizationFilterPatient extends OncePerRequestFilter {
    private static final Logger logger = LoggerFactory.getLogger(JwtAuthorizationFilterPatient.class);

    @Autowired
    private JwtHandlerPatient handler;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        try {
            ...
            if (token != null && handler.validateToken(token)) {
                ...
                String username = handler.getDniFrom(token);
